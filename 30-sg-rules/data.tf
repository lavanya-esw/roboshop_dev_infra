...
data "aws_ssm_parameter" "catalogue_sg-id"{
    name = "/${var.project}/${var.environment}/catalogue_sg_id"
}
data "aws_ssm_parameter" "user_sg-id"{
    name = "/${var.project}/${var.environment}/user_sg_id"
}
data "aws_ssm_parameter" "cart_sg-id"{
    name = "/${var.project}/${var.environment}/cart_sg_id"
}
data "aws_ssm_parameter" "shipping_sg-id"{
    name = "/${var.project}/${var.environment}/shipping_sg_id"
}
data "aws_ssm_parameter" "payment_sg-id"{
