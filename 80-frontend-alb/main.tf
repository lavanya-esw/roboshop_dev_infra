...
resource "aws_lb_listener" "frontend_alb" {
  ...
  port              = "443"
  protocol          = "HTTPS"
  ssl_policy        = "ELBSecurityPolicy-TLS13-1-3-2021-06" # Or a more recent, secure policy
  certificate_arn   = local.frontend_alb_certificate_arn# Replace with your ACM certificate ARN
